    ...
    <div class="container">
        ...
        <form
            ...
            <div class="mb-3">
                ...
                @enderror
                {{-- Pesan tambahan untuk memberi tahu user --}}
                @if (!isset($permission))
                    <small class="text-muted">Note: Setelah submit, 4 permission otomatis akan dibuat:
                        <strong>view, create, edit, delete</strong> untuk nama yang Anda masukkan.</small>
                @endif
            </div>
