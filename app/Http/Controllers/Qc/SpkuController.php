...
class SpkuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('qc.spku.index', compact('spku'));
    }
    public function create()
    {
        ...
        return view('qc.spku.create', compact('jnpn', 'newSpkuCode'));
    }
    ...
    public function show($id)
    {
        ...
        return view('qc.spku.show', compact('spku'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('qc.spku.edit', compact('spku', 'jnpn'));
    }
    ...
    public function laporan(Request $request)
    {
        ...
        return view('qc.spku.rekap', compact('totalspkuperline', 'spkuperunit', 'jenisspku', 'tahun', 'spkuperbulan'));
    }
}
